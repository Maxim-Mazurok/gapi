...
/* JS */
// loaded_0 - generated by api.js, passed in query string, like this: `cb=gapi.loaded_0`
gapi.loaded_0(function (_) {
  // "_" - window.gapi._ or window.__jsl.H._
  var window = this;
...
*/
  var FUNC_1, ya, Ja, Ka, Ma, Na;
  _.ia = function (a) {
    return function () {
      return _.ha[a].apply(this, arguments);
    };
  };
  _._DumpException = function (__UM__EXCEPTION) {
    throw __UM__EXCEPTION;
  };

  // _.ha = [];
  _.__UM__SOME_ARRAY_1 = [];
  ...
  //   };
  // };
  FUNC_1 = function (__UM__ARRAY_ARG) {
    var __UM____UM__ARRAY_ARG__INDEX = 0;
    return function () {
      return __UM__ARRAY_ARG.length > __UM____UM__ARRAY_ARG__INDEX
        ? {
            done: false,
            value: __UM__ARRAY_ARG[__UM____UM__ARRAY_ARG__INDEX++],
          }
        : { done: true };
    };
  };
  ...
  _.va = function (a) {
    ...
    return b ? b.call(a) : { next: FUNC_1(a) };
  };
  _.wa =
